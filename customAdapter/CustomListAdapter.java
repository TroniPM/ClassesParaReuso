...
public class CustomListAdapter extends ArrayAdapter<Nota> {
	/*
	* To use this:
	* CustomListAdapter customAdapter = new CustomListAdapter(getActivity(), R.layout.item_list_row, dados, null);
